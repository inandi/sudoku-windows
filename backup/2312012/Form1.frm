...
Private Sub About_Click()
    ...
    str = str + "Your Comment & Appriciation is awaited......"
    txthlp.Left = 120
    txthlp.Top = 240
    frmhlp.Left = 120
    frmhlp.Top = 240
...
Shell "explorer.exe http://search.4shared.com/postDownload/izqI_CK_/SO_online.html"
...
Private Sub FinishGame()
    ...
    If Label81.Caption <> "" Then
        ...
        End If
'        timermarquee_Timer
        MsgBox "You Took Total " & FinishTimeT & " sec; Hence You Scored  " & FinishScore & " % !", vbInformation, "Game Over"
        timermarquee_Timer
        ResetGrid
'        finishI = 0
'        FinishB = False
